...
DOC_URL?=https://shedclient.readthedocs.org
...
coverage:
	coverage run --source shedclient setup.py test
	coverage report -m
	coverage html
	open htmlcov/index.html || xdg-open htmlcov/index.html

docs:
	$(IN_VENV) sphinx-apidoc -f -o docs/ shedclient
